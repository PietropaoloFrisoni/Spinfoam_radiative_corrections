...
function self_energy(cutoff)
    ...
    for pcutoff = 0:step:cutoff
        ...
        for j23::HalfInt = 0:onehalf:pcutoff, j25::HalfInt = 0:onehalf:pcutoff
            ...
            i2, _ = intertwiner_range(jb, jb, j23, j25)
            i3, _ = intertwiner_range(jb, jb, j23, jb)
        ...
        @time tampl = @sync @distributed (+) for spins in spins_all
            ...
            i2, i2_range = intertwiner_range(jb, jb, j23, j25)
            i3, i3_range = intertwiner_range(jb, j23, jb, j25)
            i4, i4_range = intertwiner_range(jb, jb, j23, jb)
            i5, i5_range = intertwiner_range(jb, jb, j23, jb)

            # compute vertex
            v1 = vertex_BF_compute([jb, jb, jb, jb, jb, j23, jb, jb, j23, j25])
            v2 = vertex_BF_compute([jb, jb, jb, jb, j25, j23, jb, jb, j23, jb])
            ...
            for i2 in 1:i2_range, i3 in 1:i3_range, i4 in 1:i4_range, i5 in 1:i5_range
                amp += v1.a[i2, i3, i4, i5, 1] * v2.a[i4, i5, i3, i2, 1]
            end
...
CSV.write("$(STORE_FOLDER)/self_energy_bounded.csv", df)
