...
function self_energy_EPRL(cutoff, shells)
    ...
    for pcutoff = 0:step:cutoff
        ...
        for j23::HalfInt = 0:onehalf:pcutoff, j25::HalfInt = 0:onehalf:pcutoff
            ...
            i2, _ = intertwiner_range(jb, j23, j23, jb)
            i3, _ = intertwiner_range(jb, jb, j23, j25)
        ...
        @time tampl = @sync @distributed (+) for spins in spins_all
            ...
            i2, i2_range = intertwiner_range(jb, j23, j23, jb)
            i3, i3_range = intertwiner_range(jb, jb, j23, j25)
            i4, i4_range = intertwiner_range(jb, jb, j23, j25)
            i5, i5_range = intertwiner_range(jb, j23, j23, jb)
            reduced_range = ((0, 0), i2, i3, i4, i5)

            # compute vertex
            v = vertex_compute([jb, jb, jb, jb, jb, j23, j23, j25, j23, jb], shells, reduced_range; result=result_return)
            ...
            for i2 in 1:i2_range, i3 in 1:i3_range, i4 in 1:i4_range, i5 in 1:i5_range
                amp += v.a[i5, i3, i4, i2, 1] * v.a[i5, i4, i3, i2, 1]
            end
...
CSV.write("$(STORE_FOLDER)/self_energy_2_Dl_min_$(SHELL_MIN)_Dl_max_$(SHELL_MAX).csv", df)
