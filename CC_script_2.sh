...
#SBATCH --job-name=self_energy_2
#SBATCH --output=CLUSTER_COMPUTATIONS/self_energy_2.log
#SBATCH --error=CLUSTER_COMPUTATIONS/self_energy_2.err
...
BSPIN=0.5
CODE_TO_RUN=self_energy_2_EPRL
